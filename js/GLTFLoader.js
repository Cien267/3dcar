...
THREE.GLTFLoader = (function () {
          ...
          try {
            ...
            if (onError !== undefined) {
              ...
              onError(
                e.constructor === Error
                  ? e
                  : new Error("THREE.GLTFLoader: Unable to parse model.")
              )
            }
          }
        },
    ...
    if (materialValues.diffuseTexture !== undefined) {
      pending.push(
        parser.assignTexture(
          materialParams,
          "map",
          materialValues.diffuseTexture.index
        )
      )
    }
    ...
    if (materialValues.specularTexture !== undefined) {
      pending.push(
        parser.assignTexture(
          materialParams,
          "specularMap",
          materialValues.specularTexture.index
        )
      )
    }
  ...
  GLTFParser.prototype.parse = function (onLoad, onError) {
    ...
    this._withDependencies(["scenes", "animations"])
  ...
  GLTFParser.prototype.loadAccessors = function () {
    ...
    return _each(json.accessors, function (accessor) {
      return parser
        .getDependency("bufferView", accessor.bufferView)
      ...
      if (alphaMode !== ALPHA_MODES.OPAQUE) {
        ...
        if (alphaMode === ALPHA_MODES.MASK) {
          materialParams.alphaTest =
            material.alphaCutoff !== undefined ? material.alphaCutoff : 0.5
        }
      } else {
